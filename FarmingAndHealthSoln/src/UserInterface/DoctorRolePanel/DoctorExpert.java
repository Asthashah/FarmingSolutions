...
//        pic.setIcon(icon);
    ...
    private void initComponents() {
        ...
        pic.setText("jLabel3");
        jPanel1.add(pic, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1570, 1200));
    ...
    private void healthCheckBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_healthCheckBtnActionPerformed
        ...
        if(rowSelect >= 0){
            ...
            if(hrr.getSender().getRole().toString().equalsIgnoreCase("GovernmentRole")){
                JOptionPane.showMessageDialog(this, "Cannot do health check for this request", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
